...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2021 at 06:13 PM
...
(3, 'status_judul', '2021-04-29 10:20:24', 'haha', 6, 1),
(4, 'status_judul', '2021-05-03 09:37:10', 'hihi', 7, 1),
(5, 'status_judul', '2021-05-03 09:42:31', 'huhu', 8, 1),
(6, 'status_link', '2021-05-03 17:02:50', NULL, 8, 1),
(7, 'status_link', '2021-05-03 17:12:03', NULL, 7, 1),
(8, 'status_judul', '2021-05-03 20:59:43', NULL, 9, 1),
(9, 'status_judul', '2021-05-03 21:44:30', NULL, 10, 1),
(10, 'status_judul', '2021-05-03 21:48:43', NULL, 11, 1);
...
(7, 'bbbbbbbbbbbbb', 'Menguasai Ms.Word, Ms.Power Point, Ms.Excel dan sebagainya', 'https://link.com', 'https://link.com', 'https://link.com', 'user/changepassword', 1),
(8, 'cobain modal lagi', 'Menguasai Database MySQL dan Oracle', 'https://link.com', 'https://link.com', 'https://link.com', 'admin/input', 1),
(9, 'bismillah berkah', 'bismillah berkah', NULL, NULL, NULL, NULL, 1),
(10, 'cobain modal lagi', 'Menguasai Database MySQL dan Oracle', NULL, NULL, NULL, NULL, 1),
(11, 'cobain modal lagi', 'Menguasai Ms.Word, Ms.Power Point, Ms.Excel dan sebagainya', NULL, NULL, NULL, NULL, 1);
...
--
ALTER TABLE `history`
  MODIFY `id_history` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
